"""
Django settings for purple_scene_dev_69373 project.
...
ROOT_URLCONF = 'purple_scene_dev_69373.urls'
...
WSGI_APPLICATION = 'purple_scene_dev_69373.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_scene_dev_69373 API",
    "DESCRIPTION": "API documentation for purple_scene_dev_69373 App",
    "VERSION": "v1",
}
